...
import { OnInit, OnDestroy, NgZone, Output, EventEmitter               } from '@angular/core'     ;
...
export class ElasticTextDirective implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    throw new Error('The `elastictext` attribute directive must be used on a `textarea` or an element that contains a `textarea`.');
  }
