...
// import { BigNumber, BigNumberConfig as BNConfig }  from 'bignumber.js' ;
...
export class SESAClient extends SESACLL {
  constructor(name?:string, fullName?:string, value?:string, code?:string, capsName?:string) {
    super(name, fullName, value, code, capsName);
  }
  public static deserialize(doc:any) {
...
export class SESALocID extends SESACLL {
  ...
  constructor(name?:string, fullName?:string, value?:string, code?:string, capsName?:string, techClass?:string) {
    super(name, fullName, value, code, capsName);
