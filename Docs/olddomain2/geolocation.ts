 ...
 * The integer represents the number of milliseconds since the start of the Unix epoch (midnight on the morning of January 1, 1970).
 */
...
export class Geolocation implements Location {
  coords: Coordinates;
  timestamp: DOMTimeStamp;
